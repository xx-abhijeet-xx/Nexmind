  ...
  return (
    <aside className={`sidebar ${sidebarOpen ? '' : 'sidebar--closed'}`}>
      ...
      <div className="sb-nav">
        <button className="nav-btn nav-btn--primary" onClick={newSession}>
        ...
        {searching ? (
          <div className="search-wrap">
            ...
            />
            {search && (
              <button className="icon-btn search-clear" onClick={() => { setSearch(''); setSearching(false); }}>
          ...
          <button className="nav-btn" onClick={() => setSearching(true)}>
      ...
      <div className="sb-footer">
        ...
        <div className="footer-btns">
          <button className="icon-btn" title="Download conversation">
